...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "c1@gmail.com", ZipCode = "123456" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("c1@gmail.com", "Forms"), null);
